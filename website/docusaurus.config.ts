...
const config: Config = {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        },
        {
          type: 'html',
          value:
            '<a href="https://www.getunleash.io/enterprise-feature-management-platform" class="navbar__item navbar__link">Product</a>',
          position: 'right',
        },
        {
          type: 'html',
        ...
        },
        {
          type: 'html',
          value:
            '<a href="https://app.unleash-hosted.com/sign-in" target="_blank" rel="noopener noreferrer" class="navbar__item navbar__link">Sign in</a>',
          position: 'right',
        },
        {
          type: 'html',
    ...
    prism: {
      additionalLanguages: ['csharp', 'dart', 'java', 'php', 'ruby', 'bash'],
    },
    languageTabs: [
      {
        highlight: 'bash',
    ...
    [
      '@docusaurus/preset-classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/Unleash/unleash/edit/main/website/',
          routeBasePath: '/',
        ...
        redirects: [
          {
            ...
            from: ['/user_guide/api-token', '/deploy/user_guide/api-token'],
          },
          {
          ...
          {
            from: ['/advanced/impression-data', '/advanced/impression_data'],
          ...
          {
            from: ['/sdks/proxy-javascript', '/sdks/javascript-browser'],
          ...
          {
            from: ['/tutorials/proxy-hosting', '/topics/proxy-hosting'],
            to: '/understanding-unleash/proxy-hosting',
          },
          {
            from: ['/tutorials/data-collection', '/topics/data-collection'],
          ...
          {
            from: ['/reference/deploy/email-service', '/deploy/email'],
            to: '/using-unleash/deploy/email-service',
          },
          {
            from: ['/reference/deploy/google-auth-hook', '/deploy/google_auth'],
          ...
          {
            from: ['/reference/deploy/import-export', '/deploy/import_export'],
