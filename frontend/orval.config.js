  ...
  unleashApi: {
    output: {
      ...
      override: {
        ...
        header: () => ['Generated by Orval', 'Do not edit manually.', 'See `gen:api` script in package.json'],
      },
    },
    input: {
      target: process.env.UNLEASH_OPENAPI_URL || 'http://localhost:4242/docs/openapi.json',
    },
    hooks: {
