...
const useParameterizedProjectApplications = createPaginatedHook<ProjectApplicationsSchema>({
  applications: [],
  total: 0,
});

export const useProjectApplications = (params: Record<string, any>, projectId: string) =>
