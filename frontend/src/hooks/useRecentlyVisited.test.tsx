  ...
  render(
    <Router initialEntries={['/']}>
      ...
      <Routes>
        ...
        <Route path='/unknown1' element={<Navigate to={'/unknown2'} />} />
        <Route path='/unknown2' element={<Navigate to={'/integrations'} />} />
        <Route path='/integrations' element={<Navigate to={'/unknown3'} />} />
        <Route path='/unknown3' element={<Navigate to={'/unknown4'} />} />
        <Route path='/unknown4' element={<Navigate to={'/segments'} />} />
