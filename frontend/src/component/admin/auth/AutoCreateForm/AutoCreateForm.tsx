...
interface IAutoCreateFormProps {
  ...
  setValue: (name: string, value: string | boolean | number | undefined) => void;
    ...
    <Fragment>
      <Grid container spacing={3} mb={2}>
        <Grid item md={5}>
          ...
          <p>Enable automatic creation of new users when signing in.</p>
        </Grid>
      ...
      <Grid container spacing={3} mb={2}>
        <Grid item md={5}>
          ...
          <p>Choose which root role the user should get when no explicit role mapping exists.</p>
        </Grid>
        <Grid item md={6}>
      ...
      <Grid container spacing={3} mb={2}>
        <Grid item md={5}>
          ...
          <p>Comma separated list of email domains that should be allowed to sign in.</p>
        </Grid>
        <Grid item md={6}>
          <TextField
