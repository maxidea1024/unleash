...
type RoleDeleteDialogRootRoleProps = {
  role?: IRole;
  open: boolean;
    ...
    >
      {entitiesWithRole ? (
        <>
          ...
          {roleUsers.length > 0 && (
            <>
              <StyledLabel>Users ({roleUsers.length}):</StyledLabel>
              <StyledTableContainer>
                <RoleDeleteDialogUsers users={roleUsers} />
              </StyledTableContainer>
            </>
          )}
          {roleServiceAccounts.length > 0 && (
            <>
              <StyledLabel>
          ...
          {roleGroups && roleGroups?.length > 0 && (
            <>
              <StyledLabel>Groups ({roleGroups.length}):</StyledLabel>
              <StyledTableContainer>
