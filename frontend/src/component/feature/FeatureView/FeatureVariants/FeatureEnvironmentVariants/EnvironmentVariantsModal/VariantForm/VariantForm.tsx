...
export const VariantForm = ({
  ...
  const isProtectedVariant = (variant: IFeatureVariantEdit): boolean => {
    ...
    return atLeastOneFixedVariant && hasOnlyOneVariableVariant && isVariable;
  };
  ...
  useEffect(() => {
    const newVariant: IFeatureVariantEdit = {
      ...
      stickiness: variants?.length > 0 ? variants[0].stickiness : 'default',
            ...
            <StyledFormControlLabel
              ...
              control={
                <Switch
                  ...
                  onChange={(e) => setCustomPercentage(e.target.checked)}
                />
              }
            />
            <StyledWeightInput
