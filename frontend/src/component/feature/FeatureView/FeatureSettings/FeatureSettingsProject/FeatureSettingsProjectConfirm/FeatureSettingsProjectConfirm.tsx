  ...
  return hasSameEnvironments &&
    ...
    >
      <StyledContainer>
        ...
        {!hasSameEnvironments && (
          <p>
            In order to move a feature flag between two projects, both projects
            must have the exact same environments enabled.
          </p>
        )}
        {hasPendingChangeRequests && (
          <>
            <p>
              The feature flag must not have any pending change requests. This
              feature flag is currently referenced in the following change
              requests:
            </p>
            <StyledList>
