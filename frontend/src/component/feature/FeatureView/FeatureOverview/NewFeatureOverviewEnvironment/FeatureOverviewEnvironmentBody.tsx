...
export const FeatureOverviewEnvironmentBody = ({
  ...
  const onDragOver =
    ...
    (event) => {
      ...
      if ((overTargetTop && draggingUp) || (overTargetBottom && !draggingUp)) {
        const newStrategies = [...strategies];
        const movedStrategy = newStrategies.splice(dragItem.index, 1)[0];
  ...
  return (
    <StyledAccordionBody>
      <StyledAccordionBodyInnerContainer>
        {strategiesToDisplay.length > 0 && isDisabled && (
          ...
          strategiesToDisplay.length < 50 || !manyStrategiesPagination ? (
            ...
            <>
              <Alert severity='error'>
                We noticed you're using a high number of activation strategies.
                To ensure a more targeted approach, consider leveraging
