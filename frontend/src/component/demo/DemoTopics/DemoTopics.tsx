  ...
  return (
    ...
    >
      <StyledAccordionSummary>
        ...
        <StyledProgress>
          <Typography variant='body2'>{percentage.toFixed()}%</Typography>
      ...
      <AccordionDetails>
        ...
        {topics.map((topic, index) => {
          ...
          const completed = stepsCompletion[index] === topic.steps.length;
          return (
            <StyledStep
              key={topic.title}
              ...
              completed={completed}
            >
              {completed ? <StyledCheckCircle /> : <StyledCircleOutlined />}
