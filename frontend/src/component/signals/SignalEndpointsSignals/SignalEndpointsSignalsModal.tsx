      ...
      >
        <StyledHeader>
          <StyledHeaderRow>
            ...
            <Link onClick={onOpenConfiguration}>View configuration</Link>
          </StyledHeaderRow>
          <StyledHeaderSubtitle>
            ...
            <StyledDescription>{signalEndpoint.description}</StyledDescription>
          </StyledHeaderSubtitle>
        </StyledHeader>
        <StyledForm>
          <SidePanelList
          ...
          <ConditionallyRender
            ...
            show={<p>No signals have been received on this signal endpoint.</p>}
          />
