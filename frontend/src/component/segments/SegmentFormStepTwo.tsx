  ...
  return (
    <>
      <StyledForm>
        ...
        <StyledAddContextContainer>
          ...
          {overSegmentValuesLimit && (
            <StyledError>
              <SegmentDocsValuesError values={segmentValuesCount} />
            </StyledError>
          )}
        </StyledAddContextContainer>
        {constraints.length === 0 && (
          <StyledNoConstraintText>
            <StyledSubtitle>
              Start adding context fields by selecting an option from above, or
              you can create a new context field and use it right away
            </StyledSubtitle>
          </StyledNoConstraintText>
        )}
      ...
      <StyledButtonContainer>
        <StyledBackButton type='button' onClick={() => setCurrentStep(1)}>
          Back
        </StyledBackButton>
        {children}
        <StyledCancelButton
