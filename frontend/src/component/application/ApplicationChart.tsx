      ...
      >
        <StyleApplicationContainer>
          <ArcherElement
            ...
            relations={data.environments.map((environment) => ({
              ...
              style: {
                strokeColor:
                  getEnvironmentMode(environment) === 'success'
          ...
          >
            <StyledApplicationBox mode={mode.applicationMode}>
              ...
              {mode.applicationMode === 'success' ? (
                ...
                <WarningStatus>{mode.issueCount} issues detected</WarningStatus>
              )}
        ...
        <StyledEnvironmentsContainer ref={elementRef}>
          {data.environments.map((environment) => (
            <ArcherElement id={environment.name} key={environment.name}>
                ...
                <StyledTable>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <StyledCell>
                        <TimeAgo date={environment.lastSeen} />
                      </StyledCell>
                    </tr>
                  </tbody>
                </StyledTable>
