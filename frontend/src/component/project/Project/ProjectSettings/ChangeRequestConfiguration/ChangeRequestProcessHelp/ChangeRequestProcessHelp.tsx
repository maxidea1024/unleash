...
export const ChangeRequestProcessHelp = () => {
  ...
  return (
    <>
      ...
      >
        <Box sx={{ p: { xs: 2, md: 4 }, maxWidth: 920 }} id={descriptionId}>
          <Typography variant='h3'>Change request process:</Typography>
          <Typography variant='body2'>
            <ol>
              <li>When changes are detected they are added to a draft.</li>
              <li>
                The user can submit the changes for review or discard them.
                <ul>
                  <li>Once submitted, the changes are visible to everyone.</li>
                </ul>
              </li>
              <li>
              ...
              <>
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      If scheduled, Ganpa will attempt to apply the changes at
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      ...
                      thus creating a conflict, Ganpa will send an email out to
                      the change request author and to the user who (last)
                      scheduled the change request.
                    </li>
                    <li>
                      If the scheduled changes contain any conflicts, Ganpa will
                      refuse to apply them.
                    </li>
                    <li>
                      If the user who scheduled the changes is removed from this
                      Ganpa instance, the scheduled changes will also not be
                      applied.
                    </li>
                  </ul>
                </li>
