...
export const lifecycleMessages: Record<keyof ProjectStatusSchemaLifecycleSummary, string> = {
  initial:
  ...
  archived: 'Flags that have been archived and are no longer in use, but kept for future reference.',
};
