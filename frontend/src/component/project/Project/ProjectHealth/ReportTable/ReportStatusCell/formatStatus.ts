...
export const formatStatus = (feature: IFeatureFlagListItem, featureTypes: FeatureTypeSchema[]): ReportingStatus => {
  ...
  if (featureType && expired(diff, featureType) && type !== KILLSWITCH && type !== PERMISSION) {
