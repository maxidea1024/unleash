  ...
  return (
    <div ref={ref}>
            ...
            {filteredTabs.map((tab) => {
              return (
                <StyledTab
                  data-loading-project
                  key={tab.title}
                  label={tab.labelOverride ? <tab.labelOverride /> : tab.title}
                  value={tab.path}
                  onClick={() => {
                    if (tab.title !== 'Flags') {
                    ...
                    navigate(isOss() && tab.ossPath ? tab.ossPath : tab.path);
                  }}
      ...
      <Routes>
        ...
        <Route path='change-requests' element={<ProjectChangeRequests />} />
        <Route
