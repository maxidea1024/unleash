...
export const ImportTimeline: FC<{
  ...
  return (
    <StyledTimeline>
      <TimelineItem>
        <TimelineSeparator>
          <StyledTimelineDot variant='outlined' active={stage === 'configure'}>
            1
          </StyledTimelineDot>
      ...
      <TimelineItem>
        <TimelineSeparator>
          <StyledTimelineDot variant='outlined' active={stage === 'validate'}>
            2
          </StyledTimelineDot>
      ...
      <TimelineItem>
        <TimelineSeparator>
          <StyledTimelineDot variant='outlined' active={stage === 'import'}>
            3
          </StyledTimelineDot>
        </TimelineSeparator>
