      ...
      <StyledFieldset>
        ...
        <StyledFlagNamingContainer>
          <StyledInput
            ...
            onChange={(e) => onSetFeatureNamingPattern(e.target.value)}
          />
          <StyledSubtitle>
          ...
          <StyledInput
            ...
            onChange={(e) => onSetFeatureNamingExample(e.target.value)}
          />
          <StyledTextField
...
The flag name should contain the project name, the feature name, and the ticket number, each separated by a dot.`}
            ...
            onChange={(e) => onSetFeatureNamingDescription(e.target.value)}
          />
        </StyledFlagNamingContainer>
      </StyledFieldset>
