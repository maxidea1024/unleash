...
import { Box, Button, IconButton, Tooltip, useTheme, styled, useMediaQuery } from '@mui/material';
...
import { fadeInTopEnter, fadeInTopLeave, fadeInTopStart } from 'themes/themeStyles';
import UIContext from 'contexts/UIContext';
import { PNPS_FEEDBACK_ID, showNPSFeedback } from 'component/feedback/FeedbackNPS/showNPSFeedback';
...
export const FeedbackNPS = ({ openUrl }: IFeedbackNPSProps) => {
  ...
  return (
    <AnimateOnMount mounted={showFeedback} start={animations.start} enter={animations.enter} leave={animations.leave}>
      <Box
      ...
      >
        ...
        >
          ...
          >
            <ThemeMode darkmode={<UnleashLogoWhite />} lightmode={<UnleashLogo />} />
            <StyledHeader>Unleash feedback</StyledHeader>
          </Box>

          <ConditionallyRender
            condition={answeredNotNow}
            show={<p>Alright, apologies for the disruption. Have a nice day!</p>}
            elseShow={<p>Hi. Do you have 2 minutes to help us improve Unleash? </p>}
          />
