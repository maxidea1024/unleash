      ...
      <StyledDiv ref={ref}>
        ...
        {state === 'attempted' && (
          <Alert severity='success' data-loading>
            ...
            If you did not receive an email, please verify that you typed in the
            correct email, and contact your administrator to make sure that you
            are in the system.
          </Alert>
        )}
        {state === 'too_many_attempts' && (
          <Alert severity='warning' data-loading>
            <AlertTitle>Too many password reset attempts</AlertTitle>
        ...
        <StyledForm onSubmit={onClick}>
          ...
          >
            {state === 'initial' ? <span>Submit</span> : <span>Try again</span>}
          </StyledButton>
