...
export const StrategyExecution: VFC<IStrategyExecutionProps> = ({ strategyResult, input }) => {
  ...
  const items = [
    ...
    hasConstraints && <ConstraintExecution constraints={constraints} input={input} />,
    hasExecutionParameters && (
      <PlaygroundResultStrategyExecutionParameters parameters={parameters} constraints={constraints} input={input} />
    ),
