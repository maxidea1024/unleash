...
import { type Dispatch, type SetStateAction, type VFC, useCallback } from 'react';
...
export const PlaygroundEditor: VFC<IPlaygroundEditorProps> = ({ context, setContext, error }) => {
