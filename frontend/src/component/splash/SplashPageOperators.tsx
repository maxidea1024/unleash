    ...
    <StyledContainer>
      <StyledContent>
        <StyledHeader>
          ...
          <StyledCloseButton onClick={() => navigate('/')} size='large'>
        ...
        <StyledBody>
          ...
          <StyledList>
            <li>
              ...
              <span>
                <strong>DATE_BEFORE</strong> <strong>DATE_AFTER</strong>
              </span>
            </li>
            <li>
        ...
        <StyledFooter>
          <p>
            <StyledLink
              ...
              rel='noreferrer'
            >
              Read all about operators in our in-depth <strong>docs</strong>
            </StyledLink>
            .
          </p>
          <p>
