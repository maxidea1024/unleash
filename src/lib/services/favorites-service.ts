...
export class FavoritesService {
  ...
  async favoriteFeature({ feature, user }: IFavoriteFeatureProps, auditUser: IAuditUser): Promise<IFavoriteFeature> {
  ...
  async unfavoriteFeature({ feature, user }: IFavoriteFeatureProps, auditUser: IAuditUser): Promise<void> {
  ...
  async favoriteProject({ project, user }: IFavoriteProjectProps, auditUser: IAuditUser): Promise<IFavoriteProject> {
  ...
  async unfavoriteProject({ project, user }: IFavoriteProjectProps, auditUser: IAuditUser): Promise<void> {
