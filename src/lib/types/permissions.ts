...
export const RELEASE_PLAN_TEMPLATE_VIEW_OVERVIEW = 'RELEASE_PLAN_TEMPLATE_VIEW_OVERVIEW';
...
export const ROOT_PERMISSION_CATEGORIES = [
  ...
  {
    label: 'Context field',
    permissions: [CREATE_CONTEXT_FIELD, UPDATE_CONTEXT_FIELD, DELETE_CONTEXT_FIELD],
  },
  {
    label: 'Project',
