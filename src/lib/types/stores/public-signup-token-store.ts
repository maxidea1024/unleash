...
export interface IPublicSignupTokenStore extends IStore<PublicSignupTokenSchema, string> {
  ...
  update(secret: string, value: { expiresAt?: Date; enabled?: boolean }): Promise<PublicSignupTokenSchema>;
