...
const flags: IFlags = {
  ...
  embedProxy: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_EMBED_PROXY, true),
  embedProxyFrontend: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_EMBED_PROXY_FRONTEND, true),
  ...
  featuresExportImport: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_FEATURES_EXPORT_IMPORT, true),
  caseInsensitiveInOperators: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_CASE_INSENSITIVE_IN_OPERATORS, false),
  ...
  disableNotifications: parseEnvVarBoolean(process.env.DISABLE_NOTIFICATIONS, false),
  ...
  adminTokenKillSwitch: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_ADMIN_TOKEN_KILL_SWITCH, false),
  ...
  showInactiveUsers: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_SHOW_INACTIVE_USERS, false),
  ...
  userAccessUIEnabled: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_USER_ACCESS_UI_ENABLED, false),
  ...
  disableShowContextFieldSelectionValues: parseEnvVarBoolean(
    process.env.UNLEASH_EXPERIMENTAL_DISABLE_SHOW_CONTEXT_FIELD_SELECTION_VALUES,
    false,
  ),
  ...
  onboardingUI: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_ONBOARDING_UI, false),
  projectRoleAssignment: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_PROJECT_ROLE_ASSIGNMENT, false),
  personalDashboardUI: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_PERSONAL_DASHBOARD_UI, false),
  trackLifecycleMetrics: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_TRACK_LIFECYCLE_METRICS, false),
  ...
  unleashAI: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_UNLEASH_AI, false),
  ...
  'enterprise-payg': parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_ENTERPRISE_PAYG, false),
  simplifyProjectOverview: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_SIMPLIFY_PROJECT_OVERVIEW, false),
  flagOverviewRedesign: parseEnvVarBoolean(process.env.UNLEASH_EXPERIMENTAL_FLAG_OVERVIEW_REDESIGN, false),
