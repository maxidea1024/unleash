...
export default class FakeClientFeatureToggleReadModel implements IClientFeatureToggleReadModel {
  constructor(private value: Record<string, Record<string, IFeatureToggleClient>> = {}) {}
