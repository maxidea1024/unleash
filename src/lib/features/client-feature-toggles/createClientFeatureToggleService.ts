...
export const createClientFeatureToggleService = (db: Db, config: IUnleashConfig): ClientFeatureToggleService => {
...
export const createFakeClientFeatureToggleService = (config: IUnleashConfig): ClientFeatureToggleService => {
