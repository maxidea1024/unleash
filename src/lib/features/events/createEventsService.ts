...
import { createAccessReadModel, createFakeAccessReadModel } from '../access/createAccessReadModel';

export const createEventsService: (db: Db, config: IUnleashConfig) => EventService = (db, config) => {
