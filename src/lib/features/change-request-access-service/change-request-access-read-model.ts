...
export interface IChangeRequestAccessReadModel {
  canBypassChangeRequest(project: string, environment: string, user?: IUser): Promise<boolean>;

  canBypassChangeRequestForProject(project: string, user?: IUser): Promise<boolean>;
