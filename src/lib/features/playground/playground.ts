...
import { type PlaygroundResponseSchema, playgroundResponseSchema } from '../../openapi/spec/playground-response-schema';
...
export default class PlaygroundController extends Controller {
  ...
  constructor(
    ...
    { openApiService, playgroundService }: Pick<IUnleashServices, 'openApiService' | 'playgroundService'>,
  ) {
    super(config);
  ...
  async evaluateContext(
    ...
    const response: PlaygroundResponseSchema = playgroundViewModel(req.body, result);
  ...
  async evaluateAdvancedContext(
    ...
    const { result, invalidContextProperties } = await this.playgroundService.evaluateAdvancedQuery(
      req.body.projects || '*',
    ...
    const response: AdvancedPlaygroundResponseSchema = advancedPlaygroundViewModel(
      req.body,
      result,
