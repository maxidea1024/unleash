...
export const createPlaygroundService = (db: Db, config: IUnleashConfig): PlaygroundService => {
...
export const createFakePlaygroundService = (config: IUnleashConfig) => {
  ...
  const featureToggleServiceV2 = createFakeFeatureToggleService(config).featureToggleService;
