...
export interface IAuthRequest<PARAM = any, ResBody = any, ReqBody = any, ReqQuery = any>
...
export interface IApiRequest<PARAM = any, ResBody = any, ReqBody = any, ReqQuery = any>
  extends Request<PARAM, ResBody, ReqBody, ReqQuery> {
  user: IApiUser;
  logout: (() => void) | ((callback: (err?: any) => void) => void);
  session: any;
